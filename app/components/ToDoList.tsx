...
const ToDoList = ({tasks}: {tasks: task[]}) => {
    ...
    return (
        <>
            <div className="flex flex-col items-center  bg-white w-screen h-200 pt-20 gap-6">
                <h1 className="text-black text-4xl align-left font-sans font-bold flex">Your to Do</h1>
                <div>
                    <form onSubmit={handleSubmit} className="flex flex-row gap-5"> 
                        ...
                        }} className="text-neutral-500 p-4 w-100 h-8 bg-black-50 border-b-2 border-black focus:outline-none"/>
